 ...
 */
@ThreadSafe
public class FixedPoolingClientConnectionManager implements ClientConnectionManager, ConnPoolControl<HttpRoute> {

    private final Log log = LogFactory.getLog(getClass());

    private final SchemeRegistry schemeRegistry;

    private final FixedHttpConnPool pool;
    ...
    public FixedPoolingClientConnectionManager(final SchemeRegistry schreg) {
        this(schreg, -1, TimeUnit.MILLISECONDS);
    }

    public FixedPoolingClientConnectionManager(final SchemeRegistry schreg,final DnsResolver dnsResolver) {
    ...
    public FixedPoolingClientConnectionManager(final SchemeRegistry schemeRegistry,
                final long timeToLive, final TimeUnit tunit,
